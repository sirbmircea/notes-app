...
public class ArgumentsHandlingService {

    private static final Logger logger = Logger.getLogger(ArgumentsHandlingService.class.getName());

    private NoteService noteService;

    public ArgumentsHandlingService() {
